...
ava::VBO ava::createVBO(const VAO vao, const void* data, size_t size, const uint32_t binding)
{
...
void ava::bindVBO(const CommandBuffer& commandBuffer, const VBO& vbo)
{
